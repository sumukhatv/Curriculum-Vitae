...
\usepackage[a4paper, left=0.5in, right=0.5in, top=0.6in, bottom=0.3in]{geometry}
...
\centerline{\small{\texttt{tvsumukha@gmail.com $|$
...
\begin{tabularx}{\textwidth}{r X}
\emph{June - Present} & \textbf{Software Engineer}, \textit{Microsoft Corporation}, Redmond, WA, USA \\
\emph{2018 \quad \quad \quad \quad} 		& \emph{Azure Core Security Services} \\
