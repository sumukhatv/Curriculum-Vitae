...
\usepackage[a4paper, left=0.5in, right=0.5in, top=0.6in, bottom=0.4in]{geometry}
...
\centerline{\small{\texttt{22 Kessler Farm Drive \#658, Nashua NH USA 03063 $|$ sumukhatv@brown.edu $|$ +1(401)660-8457}}}
...
\begin{tabularx}{\textwidth}{r X}
\emph{May} & \textbf{Software Developer Intern}, textit{Oracle America, Inc.}, Nashua, NH, USA \\
\emph{2017}				 & \emph{Oracle Clusters and Parallel Storage}\\
					 & - Involved in the development of a tool to analyse the cluster file system crash dump \\
\\ 
